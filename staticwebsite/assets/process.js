const API_URL = "https://csfqjpap59.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-doumit-2021-4150";
...
function deletePhoto(filename, title, description, tags){
    pI=$.urlParam('id');
...
function loadViewPhotoPage(){
    ...
    $.ajax({
        ...
        success: function(data) {            
            console.log(data);
            photo=data.body[0];
            htmlstr = htmlstr + '<img class=\"img-responsive\" src=\"'+photo.URL+'\" alt=\"\"> <div class=\"blog-grid-content\"> <h2 class=\"blog-grid-title-lg\"><a class=\"blog-grid-title-link\" href=\"#\">'+photo.Title+'</a></h2> <p>By: '+photo.Username+'</p> <p id="pID" name="pID">Uploaded: '+photo.CreationTime+'</p> <p>'+photo.Description+' </div>'
            $('#viewphoto-container').html(htmlstr);
            tags=photo.Tags.split(',');
            console.log(tags)
            $.each(tags, function(index, value) {
                tagstr=tagstr+'<li><a class=\"radius-5000\" href=\"#\">'+value+'</a></li>';
            });
